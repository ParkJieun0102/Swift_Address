    ...
    func parseJSON(_ data: Data){
        ...
        for i in 0..<jsonResult.count{
            ...
            if let addressNo = jsonElement["addressNo"] as? Int,
               ...
               let addressStar = jsonElement["addressStar"] as? String,
               let addressImage = jsonElement["addressImage"] as? String{
                print("addressNO:\(addressNo)")
                // 아래처럼 미리 생성해놓은 constructor 사용해도 됨.
                let query = AddressModel(addressNo: addressNo, addressName: addressName, addressPhone: addressPhone, addressEmail: addressEmail, addressText: addressText, addressBirth: addressBirth, addressStar: addressStar, addressImage: addressImage )
