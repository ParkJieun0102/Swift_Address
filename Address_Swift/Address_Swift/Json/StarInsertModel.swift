//
//  StarInsertModel.swift
//  Address_Swift
//
//  Created by JiEunPark on 2021/02/21.
//

import Foundation

class StarInsertModel: NSObject{
    
    var urlPath = "http://" + Share.localIP02 + ":8080/swift_address/starInsert_ios.jsp"
    
    
    // insertItems의 () 매개변수들은 AddViewController에서 값을 넣어줘서 함께 실행할거고 → Bool로 실행 여부 확인할거야.
    func starInsertItems(user_userEmail: String, address_addressNo: Int) -> Bool {
